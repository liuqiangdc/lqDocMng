...
type Blog struct {
	...
	//链接到的知识域中的文档ID
	DocumentId int `orm:"column(document_id);type(int);default(0);description(链接到的知识域中的文档ID)" json:"document_id"`
	//文章的标识
